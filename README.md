...
All four directories are build output and git-ignored: they are regenerated by
the command that produces them, and are not published anywhere yet. Doing that is
