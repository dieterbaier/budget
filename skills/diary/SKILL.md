...
`docs/arc42/09-architecture-decisions/`, constraints in
`docs/arc42/02-architecture-constraints/`, and those are the authority. The diary
...
| `docs/doc-005-questions-and-answers.adoc` | A question the owner answered |
